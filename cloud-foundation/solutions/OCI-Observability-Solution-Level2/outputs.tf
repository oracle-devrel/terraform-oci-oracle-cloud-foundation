...
output "oci_service_connectors" {
  value = module.oci_logging_service_connector.service_connectors
}

output "log_analytics_log_group" {
  value = module.oci_log_analytics.log_analytics_log_group
}

output "data_safe_private_endpoint" {
  value = module.oci_data_safe.data_safe_private_endpoint
}
