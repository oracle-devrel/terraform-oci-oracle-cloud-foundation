...
![](./images/PublicSector-Crowd_Counting.png)

![](./images/PublicSector-Crowd_Counting_arch.png)
...
1. Click [![Deploy to Oracle Cloud](https://oci-resourcemanager-plugin.plugins.oci.oraclecloud.com/latest/deploy-to-oracle-cloud.svg)](https://cloud.oracle.com/resourcemanager/stacks/create?region=home&zipUrl=https://github.com/oracle-devrel/terraform-oci-oracle-cloud-foundation/releases/download/v1.0.0/PublicSector-Crowd_Counting-RM.zip)
...
There are 2 docker containers running on the VM with 2 different applications:
 ...
 - The first one can be accesed from a browser and connect to : __http://<ui_data_server_public_ip>:5000__
...
The second application can be accesed from a browser and connect to : __http://<ui_data_server_public_ip>:5001 ; and wait for a couple of minutes so the AI will count the people from the cameras and will inject the data inside the database.__
