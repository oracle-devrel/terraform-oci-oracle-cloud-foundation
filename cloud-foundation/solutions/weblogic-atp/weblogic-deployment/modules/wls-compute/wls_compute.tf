module "wls_no_jrf_instance" {

// WLS instance with no JRF
source = "../../../../../../cloud-foundation/modules/cloud-foundation/instance"

instance_params = { for x in range(!local.is_apply_JRF ? var.numWLSInstances : 0) : "${local.host_label}-${x}" => {
...
module "wls-atp-instance" {

  // WLS instance with ATP
  source = "../../../../../../cloud-foundation/modules/cloud-foundation/instance"

  instance_params = { for x in range( var.is_atp_db ? var.numWLSInstances : 0) : "${local.host_label}-${x}" => {
