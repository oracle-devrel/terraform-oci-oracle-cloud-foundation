...
resource "null_resource" "sqlcl-create-usr" {
        ...
        provisioner "local-exec" {
             command = <<-EOT
                ...
                chmod 777 ./scripts/
                wget https://objectstorage.us-ashburn-1.oraclecloud.com/p/IFwRcEf0ubWd_o9zahkuHKJc_nUqx3jfGTqCz8VkSOR45exYOyouFgSnFyo4SX_R/n/c4u02/b/hosted_workshops/o/f101.sql -P ./scripts/
