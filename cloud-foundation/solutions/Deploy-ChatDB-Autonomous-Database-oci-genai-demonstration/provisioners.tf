...
resource "null_resource" "sqlcl-create-usr" {
        ...
        provisioner "local-exec" {
             command = <<-EOT
                ...
                wget https://adwc4pm.objectstorage.us-sanjose-1.oci.customer-oci.com/p/L2B_ow1NawG1bfrocaajfSOSMxcwF2IRrKr_lCjLPQzTcDbY-T7cdBOyuvNmZtRE/n/adwc4pm/b/chatdbapp/o/f101v5.4.sql -P ./scripts/
