...
module "adw" {
  source = "./modules/cloud-foundation-library/database/adw"
  adw_params = {
...
module "oac" {
  source = "./modules/cloud-foundation-library/oac"
  oac_params = {
...
module "datacatalog" {
  source = "./modules/cloud-foundation-library/datacatalog"
  datacatalog_params = {
...
module "dynamic_groups" {
  source = "./modules/oci-cis-landingzone-quickstart/iam/iam-dynamic-group"
  providers = {
    oci = oci.homeregion
  }
...
module "policies" {
  source = "./modules/oci-cis-landingzone-quickstart/security/policies"
