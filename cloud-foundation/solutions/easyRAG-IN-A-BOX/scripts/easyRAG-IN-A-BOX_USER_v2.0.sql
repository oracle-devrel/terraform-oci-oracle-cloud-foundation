...
-- v1.2 add acl verification and drop table error suppression
-- v1.3 add match_limit parameter
-- v1.4 add custom error formatting
-- v1.5 add drop if exists command and exit line for terraform
--
----------------------------------------------------------------
