# Oracle Cloud Foundation Terraform Solution - OCI Observability Solution Level 1
...
-	OCI Notification
-	OCI Events
-	Database Management Service on ADB
-	OCI Logging
...
- Quota to create the following resources: 1 ADW database instance , 1 object storage buckets, 1 notification topic with 1 subscription inside it, 2 monitoring alarms, 1 log groups with 3 logging flows, 2 events using OCI events service and enable database management for the autonomous database.
