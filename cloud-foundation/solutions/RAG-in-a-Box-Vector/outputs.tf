...
output "vectorRAG_IN_A_BOX_URL" {
  description = "The URL to connect to the vectorRAG-IN-A-BOX with your apex username and password"
  value = module.adb.vRAG_IN_A_BOX_URL
}
